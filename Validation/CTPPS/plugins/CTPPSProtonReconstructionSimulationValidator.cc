...
void CTPPSProtonReconstructionSimulationValidator::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
  ...
  // Define the parameters expected by the module
  desc.add<edm::InputTag>("tagHepMCBeforeSmearing", edm::InputTag("generator", "unsmeared"))
      ->setComment("Input tag for HepMC product before smearing");
  desc.add<edm::InputTag>("tagHepMCAfterSmearing", edm::InputTag("beamDivergenceVtxGenerator"))
      ->setComment("Input tag for HepMC product after smearing");
  desc.add<edm::InputTag>("tagRecoProtonsSingleRP", edm::InputTag("ctppsProtons", "singleRP"))
      ->setComment("Input tag for single-RP reconstructed protons");
  desc.add<edm::InputTag>("tagRecoProtonsMultiRP", edm::InputTag("ctppsProtons", "multiRP"))
      ->setComment("Input tag for multi-RP reconstructed protons");
  ...
  // Add the description to the module
  descriptions.add("ctppsProtonReconstructionSimulationValidator", desc);
}
